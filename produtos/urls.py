...
from .views import ProdutoDetail, CategoriaDetail, SubCategoriaDetail, CarrinhoView, adiciona_produto_carrinho, remove_produto_carrinho
...
urlpatterns = [
    ...
    path('carrinho/remover/<int:pk>', view=remove_produto_carrinho, name='carrinho-rm-produto')
]